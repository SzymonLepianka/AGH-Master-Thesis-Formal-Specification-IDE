...
public class ResultsPanelController {
    ...
    @FXML public TitledPane resultsPanelRoot;
    @FXML public AnchorPane resultsPanelAnchorPane;
    @FXML public TextArea patternExpressionTextArea;
    @FXML public TextArea folTextArea;
    @FXML public TextArea ltlTextArea;
